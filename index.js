...
//https://api.openweathermap.org/data/2.5/weather?q=roorkee&appid=efa11dfb627fd27c037faa094ba9b635
...
const server=http.createServer((req, res)=>{
    if(req.url=="/"){
       requests("https://api.openweathermap.org/data/2.5/weather?q=roorkee&appid=efa11dfb627fd27c037faa094ba9b635")
       .on("data",(chunk)=>{
